<link rel="stylesheet" href="/styles/reusable/navigation.css" />

<div id="navigation-menu">
  <nav class="top-bar">
    <div>
      <div class="left">
        <a href="http://192.168.0.100" class="logo">
          <svg viewBox="0 0 245 50">
            <path
            ...
            ></path>
            <path
              d="M149.5,49.33V29.63h-4.6V25.84h4.6V18.49H154v7.35h4.6v3.79H154v19.7Z"
            ></path>
            <path
      ...
      <div class="laptop__nav">
        <ul class="laptop__menu">
          <li>
            <label>
              <a href="http://192.168.0.100/about">About</a>
            </label>
          </li>
          ...
          <li>
            ...
            <ul class="laptop__submenu">
              <a href="http://192.168.0.100/resources/paper">Paper</a>
              <a href="http://192.168.0.100/resources/faqs">FAQs</a>
              <a href="http://192.168.0.100/resources/brand-guidelines"
                >Brand Guidelines</a
              >
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="laptop__submenu">
              <a href="http://192.168.0.100/platform/features">Features</a>
              <a href="http://192.168.0.100/platform/limitation">Limitation</a>
              <a href="http://192.168.0.100/platform/workflow">Workflow</a>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="laptop__submenu">
              <a>Roger's Website</a>
              <a href="https://github.com/Gasofa06/Solitude" target="_blank"
                >GitHub</a
              >
              <a href="https://twitter.com/rovi_roger" target="_blank"
                >X User</a
              >
            </ul>
          </li>
      ...
      <div class="right">
        <div class="laptop__toggle-theme">
          <div class="toggle-theme">
            <input type="checkbox" />
            <div>
              <img src="/assets/svgs/laptop-theme-light.svg" />
              <img src="/assets/svgs/laptop-theme-dark.svg" />
            </div>
          </div>
        </div>

        <div class="laptop__search-btn">
          <form action="http://192.168.0.100:5555">
            <button class="btn-model-three black">
              Search
              <svg viewBox="0 0 17 15">
                <path d="M9 0.5L16 7.5L9 14.5"></path>
                <line x1="16" y1="7.5" y2="7.5"></line>
              </svg>
            </button>
          </form>
        </div>
    ...
    <div>
      <ul class="mobile__menu">
        <li>
          ...
          <a href="http://192.168.0.100:5555">Search</a>
          <a href="http://192.168.0.100/about">About</a>
        </li>
      ...
      <footer class="mobile__footer-menu">
        <div>
          <div class="mobile__toggle-theme">
            <div class="toggle-theme">
              <input type="checkbox" />
              <div>
                <img src="/assets/svgs/mobile-theme-light.svg" />
                <img src="/assets/svgs/mobile-theme-dark.svg" />
              </div>
            </div>
          </div>
          ...
          <a
            class="github"
            href="https://github.com/Gasofa06/Solitude"
            target="_blank"
          >
            <img alt="GitHub" src="/assets/svgs/github-mark-white.svg" />
            <img alt="GitHub" src="/assets/svgs/github-mark.svg" />
          </a>

          <a class="x" href="https://twitter.com/rovi_roger" target="_blank">
            <img alt="X" src="/assets/svgs/x-mark-white.svg" />
            <img alt="X" src="/assets/svgs/x-mark.svg" />
          </a>
        </div>
